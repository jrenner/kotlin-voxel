...
public class SmartFontGenerator {
	...
	public BitmapFont createFont(FileHandle fontFile, String fontName, int fontSize, String fontChars) {
		...
		if (!loaded || forceGeneration) {
			...
			font = generateFontWriteFiles(fontName, fontFile, fontSize, pageSize, pageSize, fontChars);
		}
		return font;
	}
	 ...
	 * @param fontSize
	 */
	private BitmapFont generateFontWriteFiles(String fontName, FileHandle fontFile, int fontSize, int pageWidth, int pageHeight, String fontCharacters) {
		...
		params.characters = fontCharacters;
		params.packer = packer;
		//FreeTypeFontGenerator.FreeTypeBitmapFontData fontData = generator.generateData(fontSize, fontCharacters, false, packer);
		FreeTypeFontGenerator.FreeTypeBitmapFontData fontData = generator.generateData(params);
		...
		Array<TextureRegion> texRegArr = new Array<>();
		texRegArr.addAll(texRegions);
		BitmapFont font = new BitmapFont(fontData, texRegArr, false);
